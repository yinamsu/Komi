...
const translations = {
    en: {
        ...
        "hero.headline": "Visiting Seoul for K-Beauty? <br>",
        "hero.headline_gradient": "Tired of fake reviews & \"factory\" clinics?",
        "hero.subheadline": "1) 100% visit-verified authentic reviews<br>2) Real experiences and honest feedback from foreign patients<br>3) Zero sponsorship or sponsored ads<br>4) Accurate and transparent treatment pricing<br>5) Hand-pick doctors with high aesthetic standards<br>6) Post-treatment care even after returning home",
        ...
        "filter.doc_gp": "General Practitioner",
        "filter.experience": "Experience",
        "filter.exp_05": "0-5 Years",
        "filter.exp_510": "5-10 Years",
        "filter.exp_10p": "10+ Years",
        "filter.auth_benefits": "Certifications & Benefits",
        "filter.auth_registered": "Foreigner Attraction Registered",
        "filter.auth_excellent": "Aftercare Excellence",
        "filter.review_title": "⭐ Review Category Filter (Rating 0-5 Stars)",
        "filter.option_all": "All",
        "filter.r_satisfaction": "Treatment Satisfaction",
        "filter.r_cost": "Value for Money",
        "filter.r_contact_speed": "Response Speed",
        "filter.r_waiting_speed": "On-site Wait Time",
        "filter.r_language": "Language Convenience",
        "filter.r_staff_kindness": "Staff Friendliness",
        "filter.r_doctor_explanation": "Doctor's Explanation",
        "filter.r_honesty": "Honest Treatment",
        "filter.r_location": "Location Convenience",
        "filter.r_facility": "Facility Comfort",
        "filter.r_aftercare": "Aftercare Satisfaction",
        "filter.r_parking": "Parking Convenience",

        "compare.title": "Custom Design Treatment vs. Factory-Style Batch Treatment",
        ...
        "compare.factory_price_html": "100,000 <span>KRW</span>",
        "compare.boutique_price_html": "200,000 <span>KRW</span>",
        "compare.boutique_badge": "VIP Standard",
        ...
        "compare.factory_consult_desc": "Sales rep pushes packages with commission margin goals.",
        "compare.factory_risk_desc": "Settings default to hardcoded presets, high danger for global skins.",
        "compare.factory_care_desc": "Rushed discharge after treatment, no communication channel after flight.",
        "compare.boutique_consult_desc": "1:1 design consultation directly analyzing skin thickness and barrier.",
        "compare.boutique_risk_desc": "Adjusting pulse length and cooling parameters based on Fitzpatrick scale.",
        "compare.boutique_care_desc": "Dedicated recovery checklist support even after you return to your home country.",
        ...
        "cat.epilation": "Hair Removal",
        "cat.dental": "Dental",
        "cat.herbal": "Oriental Medicine",
        "cat.others": "Others",

        "subcat.skin_booster": "Skin Boosters",
        "subcat.peeling": "Peeling/Exfoliation",
        "subcat.whitening": "Whitening/Pigmentation",
        "subcat.acne": "Acne/Scars",
        "subcat.mole": "Mole/Wart",
        "subcat.laser_lifting": "Laser Lifting",
        "subcat.thread_lifting": "Thread Lifting",
        "subcat.lifting_injection": "Lifting Injections",
        "subcat.wrinkle_botox": "Wrinkle Botox",
        "subcat.area_botox": "Area-Specific Botox",
        "subcat.volume_filler": "Facial Volume Filler",
        "subcat.feature_filler": "Feature Filler",
        "subcat.body_filler": "Body Filler",
        "subcat.double_eyelid": "Double Eyelid",
        "subcat.canthoplasty": "Epicanthoplasty/Canthoplasty",
        "subcat.ptosis_correction": "Ptosis Correction",
        "subcat.eye_aging": "Eye Rejuvenation",
        "subcat.eye_revision": "Eye Revision",
        "subcat.nose_structure": "Bridge/Tip Surgery",
        "subcat.functional_nose": "Functional Rhinoplasty",
        "subcat.nose_correction": "Nose Shape Correction",
        "subcat.nose_revision": "Rhinoplasty Revision",
        "subcat.facial_contour": "Facial Contouring",
        "subcat.orthognathic": "Orthognathic Surgery",
        "subcat.forehead_implant": "Forehead Contouring",
        "subcat.liposuction": "Liposuction",
        "subcat.fat_graft": "Fat Grafting",
        "subcat.breast_aug": "Breast Augmentation",
        "subcat.breast_reduction": "Breast Reduction/Lift",
        "subcat.nipple_gyne": "Nipple/Gynecomastia",
        "subcat.hair_transplant": "Hair Transplant",
        "subcat.hair_loss_treat": "Hair Loss Treatment",
        "subcat.laser_epilation": "Laser Hair Removal",
        "subcat.aesthetic_dental": "Aesthetic Dental",
        "subcat.orthodontic_dental": "Orthodontics",
        "subcat.whitening_implant": "Whitening/Implant",
        "subcat.herbal_diet": "Herbal Diet",
        "subcat.herbal_proc": "Herbal Procedure",
        "subcat.misc_treat": "Miscellaneous",

        "treat.rejuran": "Rejuran Healer",
        "treat.exosome": "Exosome",
        "treat.juvelook": "Juvelook",
        "treat.water_glow": "Water Glow Injection",
        "treat.aqua_peel": "Aqua Peel",
        "treat.aladdin_peel": "Aladdin Peel",
        "treat.milk_peel": "Milk Peel",
        "treat.toning": "Laser Toning",
        "treat.ipl": "IPL",
        "treat.pico": "Pico Toning",
        "treat.co2": "CO2 Laser",
        "treat.fraxel": "Fraxel",
        "treat.agnes": "Agnes",
        "treat.pdt": "PDT",
        "treat.mole_removal": "Mole/Wart Removal",
        "treat.ulthera": "Ulthera",
        "treat.shurink": "Shurink",
        "treat.inmode": "Inmode",
        "treat.thermage": "Thermage",
        "treat.oligio": "Oligio",
        "treat.mint": "Mint Thread",
        "treat.silhouette": "Silhouette Soft",
        "treat.contour_inj": "Contour Injection",
        "treat.sculpt_inj": "Sculpting Injection",
        "treat.double_chin_inj": "Double Chin Injection",
        "treat.frown": "Frown Lines Botox",
        "treat.forehead_b": "Forehead Botox",
        "treat.crow": "Crow's Feet Botox",
        "treat.lips_b": "Lips Botox",
        "treat.pebbled_chin": "Pebbled Chin Botox",
        "treat.jaw_b": "Square Jaw Botox",
        "treat.salivary": "Salivary Glands Botox",
        "treat.trapezius": "Trapezius Botox",
        "treat.calves": "Calves Botox",
        "treat.hyperhidrosis": "Hyperhidrosis Botox",
        "treat.forehead_f": "Forehead Filler",
        "treat.cheek_f": "Front Cheek Filler",
        "treat.cheek_vol": "Cheek Filler",
        "treat.nasolabial": "Nasolabial Folds Filler",
        "treat.chin_tip": "Chin Tip Filler",
        "treat.nose_f": "Nose Filler",
        "treat.lips_f": "Lips Filler",
        "treat.lip_corners": "Lip Corners Filler",
        "treat.aegyo": "Under-Eye Aegyo Sal",
        "treat.pelvis_f": "Pelvis Filler",
        "treat.hip_up": "Hip-Up Filler",
        "treat.natural_double": "Natural Adhesion Double Eyelid",
        "treat.incisional_double": "Incisional Double Eyelid",
        "treat.partial_double": "Partial Incisional Double Eyelid",
        "treat.front_cant": "Front Canthoplasty",
        "treat.top_cant": "Top Canthoplasty",
        "treat.back_cant": "Back Canthoplasty",
        "treat.bottom_cant": "Bottom Canthoplasty",
        "treat.non_incisional_ptosis": "Non-incisional Ptosis Correction",
        "treat.incisional_ptosis": "Incisional Ptosis Correction",
        "treat.undereye_fat": "Under-Eye Fat Relocation",
        "treat.upper_bleph": "Upper Blepharoplasty",
        "treat.lower_bleph": "Lower Blepharoplasty",
        "treat.eye_revision": "Eye Revision Surgery",
        "treat.silicone_nose": "Silicone Rhinoplasty",
        "treat.cartilage_nose": "Autologous Cartilage Rhinoplasty",
        "treat.functional_nose": "Functional Rhinoplasty (Rhinitis/Septal Deviation)",
        "treat.alar_reduction": "Alar Reduction",
        "treat.bulbous_nose": "Bulbous Nose Correction",
        "treat.hump_nose": "Hump Nose Correction",
        "treat.nose_revision": "Rhinoplasty Revision",
        "treat.jaw_reduction": "Square Jaw Reduction",
        "treat.cheekbone_red": "Cheekbone Reduction",
        "treat.chin_surg": "Chin Surgery",
        "treat.orthognathic": "Orthognathic Surgery",
        "treat.protruding_mouth": "Protruding Mouth Surgery",
        "treat.forehead_contour": "Forehead Contouring",
        "treat.implant_insert": "Implant Insertion",
        "treat.abdomen_lipo": "Abdomen Liposuction",
        "treat.thigh_lipo": "Thighs Liposuction",
        "treat.forearm_lipo": "Forearms Liposuction",
        "treat.face_lipo": "Double Chin/Face Liposuction",
        "treat.full_face_fat": "Full Face Fat Grafting",
        "treat.area_fat": "Area-Specific Fat Grafting",
        "treat.motiva": "Motiva Breast Augmentation",
        "treat.mentor": "Mentor Breast Augmentation",
        "treat.fat_breast": "Autologous Fat Breast Augmentation",
        "treat.breast_reduction": "Breast Reduction",
        "treat.breast_lift": "Sagging Breast Correction",
        "treat.inverted_nipple": "Inverted Nipple Correction",
        "treat.nipple_reduction": "Nipple Reduction",
        "treat.gynecomastia": "Gynecomastia Treatment",
        "treat.incisional_hair": "Incisional Hair Transplant",
        "treat.non_incisional_hair": "Non-incisional Hair Transplant",
        "treat.meso": "Scalp Mesotherapy",
        "treat.hairline": "Hairline Correction",
        "treat.underarm_ep": "Underarms Hair Removal",
        "treat.limbs_ep": "Arms/Legs Hair Removal",
        "treat.lip_ep": "Upper Lip Hair Removal",
        "treat.bikini_ep": "Bikini/Brazilian Hair Removal",
        "treat.face_ep": "Full Face Hair Removal",
        "treat.laminate": "Laminate",
        "treat.all_ceramic": "All-Ceramic",
        "treat.clippy_c": "Clippy-C Orthodontics",
        "treat.clear_align": "Clear Aligners",
        "treat.lingual": "Lingual Orthodontics",
        "treat.whitening": "Teeth Whitening",
        "treat.implant": "Dental Implants",
        "treat.herbal_diet_m": "Herbal Diet Medicine",
        "treat.herbal_diet_c": "Herbal Diet Capsule",
        "treat.herbal_diet_p": "Herbal Diet Pills",
        "treat.acupuncture_thread": "Acupuncture Thread Lifting",
        "treat.facial_acupuncture": "Facial Acupuncture",
        "treat.diet_herbal_inj": "Diet Herbal Injection",
        "treat.tattoo_removal": "Tattoo Removal",
        "treat.side_effect_treat": "Petit Side-Effect Treatment",
        "treat.post_op": "Post-op Management Program",
        ...
        "category.acne": "Acne",
        "category.hair_loss": "Hair Loss",
        "category.diet_injection": "Diet Injection",
        "validation.name_required": "Please fill out this field with your full name.",
    ...
    ko: {
        ...
        "hero.headline": "K-Beauty를 찾아온 외국 친구들! <br>",
        "hero.headline_gradient": "'광고성 허위리뷰', '공장형 진료'에 지치셨나요?",
        "hero.subheadline": "1) 100% 실제 고객 방문 인증 절차<br>2) 외국인 환자의 직접 경험담, 솔직한 후기<br>3) 협찬 혹은 광고 없음<br>4) 시술 비용 정확한 안내<br>5) 미감 좋은 의사를 직접 고를 수 있음<br>6) 출국 후에도 후 케어 서비스를 제공합니다",
        ...
        "filter.doc_gp": "일반의",
        "filter.experience": "시술 경력",
        "filter.exp_05": "0-5년",
        "filter.exp_510": "5-10년",
        "filter.exp_10p": "10년 이상",
        "filter.auth_benefits": "인증 및 혜택",
        "filter.auth_registered": "외국인 진료 인증기관",
        "filter.auth_excellent": "외국인 진료 우수기관",
        "filter.review_title": "⭐ 리뷰 카테고리 필터 (별점 0-5점 사이)",
        "filter.option_all": "전체",
        "filter.r_satisfaction": "시술 만족도",
        "filter.r_cost": "가성비",
        "filter.r_contact_speed": "연락 신속성",
        "filter.r_waiting_speed": "시술 대기 신속성",
        "filter.r_language": "소통 편리성(언어)",
        "filter.r_staff_kindness": "직원의 친절",
        "filter.r_doctor_explanation": "의사의 상세설명",
        "filter.r_honesty": "정직한 진료",
        "filter.r_location": "위치 편리함",
        "filter.r_facility": "시설 쾌적함",
        "filter.r_aftercare": "애프터케어 만족도",
        "filter.r_parking": "주차 편리성",

        "compare.title": "커스텀 디자인 시술 vs 공장형 일괄 시술",
        ...
        "compare.factory_price_html": "10만 원 <span>(평균 가액)</span>",
        "compare.boutique_price_html": "20만 원 <span>(1:1 맞춤형)</span>",
        "compare.boutique_badge": "VIP 표준",
        ...
        "compare.factory_consult_desc": "인센티브 마진 달성을 위해 실장이 불필요한 패키지를 강매합니다.",
        "compare.factory_risk_desc": "모든 피부 유형에 일률적인 프리셋 설정을 적용하여 화상 위험이 높습니다.",
        "compare.factory_care_desc": "치료 후 서둘러 귀가시키며, 귀국 후에는 어떠한 소통 채널도 없습니다.",
        "compare.boutique_consult_desc": "의사가 직접 피부 두께와 장벽을 진단하여 1:1 맞춤 디자인 상담을 진행합니다.",
        "compare.boutique_risk_desc": "피츠패트릭 타입에 맞춘 펄스 길이 조정 및 쿨링 매개변수 설정으로 안전합니다.",
        "compare.boutique_care_desc": "본국으로 귀국한 후에도 전용 복구 체크리스트 및 비대면 사후 관리를 보장합니다.",
        ...
        "subcat.skin_booster": "스킨부스터",
        "subcat.peeling": "필링/각질",
        "subcat.whitening": "미백/색소/기미",
        "subcat.acne": "여드름/흉터",
        "subcat.mole": "점/사마귀 제거",
        "subcat.laser_lifting": "레이저 리프팅",
        "subcat.thread_lifting": "실리프팅",
        "subcat.lifting_injection": "리프팅 주사",
        "subcat.wrinkle_botox": "주름 보톡스",
        "subcat.area_botox": "부위별 보톡스",
        "subcat.volume_filler": "얼굴 볼륨 필러",
        "subcat.feature_filler": "이목구비 필러",
        "subcat.body_filler": "바디 필러",
        "subcat.double_eyelid": "쌍꺼풀 수술",
        "subcat.canthoplasty": "트임 성형",
        "subcat.ptosis_correction": "눈매 교정",
        "subcat.eye_aging": "눈가 노화 성형",
        "subcat.eye_revision": "눈재수술",
        "subcat.nose_structure": "콧대/코끝 성형",
        "subcat.functional_nose": "기능코 성형",
        "subcat.nose_correction": "콧볼 축소/복코/매부리코 교정",
        "subcat.nose_revision": "코재수술",
        "subcat.facial_contour": "안면윤곽",
        "subcat.orthognathic": "양악 수술 / 돌출입 수술",
        "subcat.forehead_implant": "이마 성형 / 보형물 삽입",
        "subcat.liposuction": "지방흡입",
        "subcat.fat_graft": "지방이식",
        "subcat.breast_aug": "가슴 확대 수술",
        "subcat.breast_reduction": "가슴 축소 / 처진 가슴 교정",
        "subcat.nipple_gyne": "유두 성형 / 여유증",
        "subcat.hair_transplant": "모발이식",
        "subcat.hair_loss_treat": "탈모 치료",
        "subcat.laser_epilation": "레이저 제모",
        "subcat.aesthetic_dental": "라미네이트 / 올세라믹",
        "subcat.orthodontic_dental": "치아 교정",
        "subcat.whitening_implant": "치아 미백 / 임플란트",
        "subcat.herbal_diet": "한방 다이어트",
        "subcat.herbal_proc": "한방 시술",
        "subcat.misc_treat": "기타 치료",

        "treat.rejuran": "리쥬란 힐러",
        "treat.exosome": "엑소좀",
        "treat.juvelook": "쥬베룩",
        "treat.water_glow": "물광주사",
        "treat.aqua_peel": "아쿠아필",
        "treat.aladdin_peel": "알라딘필",
        "treat.milk_peel": "밀크필",
        "treat.toning": "토닝",
        "treat.ipl": "IPL",
        "treat.pico": "피코토닝",
        ...
        "treat.oligio": "올리지오",
        "treat.mint": "민트실",
        "treat.silhouette": "실루엣소프트",
        "treat.contour_inj": "윤곽주사",
        "treat.sculpt_inj": "조각주사",
        "treat.double_chin_inj": "이중턱 주사",
        "treat.frown": "미간 보톡스",
        "treat.forehead_b": "이마 보톡스",
        "treat.crow": "눈가 보톡스",
        "treat.lips_b": "입술 보톡스",
        "treat.pebbled_chin": "자갈턱 보톡스",
        "treat.jaw_b": "사각턱 보톡스",
        "treat.salivary": "침샘 보톡스",
        "treat.trapezius": "승모근 보톡스",
        "treat.calves": "종아리 보톡스",
        "treat.hyperhidrosis": "다한증 보톡스",
        "treat.forehead_f": "이마 필러",
        "treat.cheek_f": "앞광대 필러",
        "treat.cheek_vol": "볼 필러",
        "treat.nasolabial": "팔자주름 필러",
        "treat.chin_tip": "턱끝 필러",
        "treat.nose_f": "코 필러",
        "treat.lips_f": "입술 필러",
        "treat.lip_corners": "입꼬리 필러",
        "treat.aegyo": "애교살 필러",
        "treat.pelvis_f": "골반 필러",
        "treat.hip_up": "힙업 필러",
        "treat.natural_double": "매몰/자연유착 쌍꺼풀",
        "treat.incisional_double": "절개 쌍꺼풀",
        "treat.partial_double": "부분절개 쌍꺼풀",
        "treat.front_cant": "앞트임",
        "treat.top_cant": "윗트임",
        "treat.back_cant": "뒤트임",
        "treat.bottom_cant": "밑트임",
        "treat.non_incisional_ptosis": "비절개 눈매교정",
        "treat.incisional_ptosis": "절개 눈매교정",
        "treat.undereye_fat": "눈밑지방재배치",
        "treat.upper_bleph": "상안검 수술",
        "treat.lower_bleph": "하안검 수술",
        "treat.eye_revision": "눈재수술",
        "treat.silicone_nose": "실리콘 콧대/코끝 성형",
        "treat.cartilage_nose": "자가연골 콧대/코끝 성형",
        "treat.functional_nose": "기능코 성형 (비염/비중격만곡증 개선)",
        "treat.alar_reduction": "콧볼 축소",
        "treat.bulbous_nose": "복코 교정",
        "treat.hump_nose": "매부리코 교정",
        "treat.nose_revision": "코재수술",
        "treat.jaw_reduction": "사각턱 수술",
        "treat.cheekbone_red": "광대축소술",
        "treat.chin_surg": "턱끝 수술",
        "treat.orthognathic": "양악 수술",
        "treat.protruding_mouth": "돌출입 수술",
        "treat.forehead_contour": "이마 성형",
        "treat.implant_insert": "보형물 삽입",
        "treat.abdomen_lipo": "복부 지방흡입",
        "treat.thigh_lipo": "허벅지 지방흡입",
        "treat.forearm_lipo": "팔뚝 지방흡입",
        "treat.face_lipo": "이중턱/얼굴 지방흡입",
        "treat.full_face_fat": "풀페이스 지방이식",
        "treat.area_fat": "부위별 지방이식",
        "treat.motiva": "모티바 가슴 확대",
        "treat.mentor": "멘토 가슴 확대",
        "treat.fat_breast": "자가지방 가슴 확대",
        "treat.breast_reduction": "가슴 축소 수술",
        "treat.breast_lift": "처진 가슴 교정",
        "treat.inverted_nipple": "함몰유두 성형",
        "treat.nipple_reduction": "유두축소 성형",
        "treat.gynecomastia": "여성형 유방증 (여유증) 수술",
        "treat.incisional_hair": "절개 모발이식",
        "treat.non_incisional_hair": "비절개 모발이식",
        "treat.meso": "두피 메조테라피",
        "treat.hairline": "헤어라인 교정",
        "treat.underarm_ep": "겨드랑이 제모",
        "treat.limbs_ep": "팔/다리 제모",
        "treat.lip_ep": "인중 제모",
        "treat.bikini_ep": "비키니/브라질리언 제모",
        "treat.face_ep": "얼굴 전체 제모",
        "treat.laminate": "라미네이트",
        "treat.all_ceramic": "올세라믹",
        "treat.clippy_c": "클리피씨 교정",
        "treat.clear_align": "투명교정",
        "treat.lingual": "설측교정",
        "treat.whitening": "치아 미백",
        "treat.implant": "임플란트",
        "treat.herbal_diet_m": "다이어트 한약",
        "treat.herbal_diet_c": "다이어트 캡슐",
        "treat.herbal_diet_p": "다이어트 환",
        "treat.acupuncture_thread": "매선 침",
        "treat.facial_acupuncture": "윤곽 침",
        "treat.diet_herbal_inj": "다이어트 약침",
        "treat.tattoo_removal": "문신제거",
        "treat.side_effect_treat": "쁘띠 성형 부작용 치료",
        "treat.post_op": "수술 후 관리 프로그램",
        ...
        "category.pigment": "색소",
        "category.acne": "여드름",
        "category.hair_loss": "탈모",
        "category.diet_injection": "비만주사",
        "validation.name_required": "성함을 입력해 주세요.",
    ...
    ja: {
        // ---- Categories & Filters ----
        "category.menu_title": "ご興味のある施術分野を選択してください",
        "search.placeholder": "施術を検索（例：ピコ、Nd:YAG、ウルセラ...）",
        "filter.all": "すべての施術",
        ...
        "subcat.skin_booster": "スキンブースター",
        "subcat.peeling": "ピーリング/角質ケア",
        "subcat.whitening": "美白/色素沈着",
        "subcat.acne": "ニキビ/ニキビ跡",
        "subcat.mole": "ほくろ/いぼ",
        "subcat.laser_lifting": "レーザーリフティング",
        "subcat.thread_lifting": "糸リフティング",
        "subcat.lifting_injection": "輪郭注射/リフト注射",
        "subcat.wrinkle_botox": "シワボトックス",
        "subcat.area_botox": "部位別ボトックス",
        "subcat.volume_filler": "ボリュームフィラー",
        "subcat.feature_filler": "パーツフィラー",
        "subcat.body_filler": "ボディフィラー",
        "subcat.double_eyelid": "二重整形",
        "subcat.canthoplasty": "目頭・目尻切開",
        "subcat.ptosis_correction": "眼瞼下垂矯正",
        "subcat.eye_aging": "目の下たるみ取り",
        "subcat.eye_revision": "二重修正",
        "subcat.nose_structure": "鼻筋・鼻先整形",
        "subcat.functional_nose": "機能的鼻整形",
        "subcat.nose_correction": "小鼻縮小/鼻修正",
        "subcat.nose_revision": "鼻再手術",
        "subcat.facial_contour": "輪郭3点/骨削り",
        "subcat.orthognathic": "両顎手術",
        "subcat.forehead_implant": "おでこ整形",
        "subcat.liposuction": "脂肪吸引",
        "subcat.fat_graft": "脂肪移植",
        "subcat.breast_aug": "豊胸手術",
        "subcat.breast_reduction": "乳房縮小/リフト",
        "subcat.nipple_gyne": "乳頭縮小/女乳症",
        "subcat.hair_transplant": "自毛植毛",
        "subcat.hair_loss_treat": "薄毛治療",
        "subcat.laser_epilation": "レーザー脱毛",
        "subcat.aesthetic_dental": "ラミネート/審美",
        "subcat.orthodontic_dental": "Orthodontics",
        "subcat.whitening_implant": "ホワイトニング/インプラント",
        "subcat.herbal_diet": "韓方ダイエット",
        "subcat.herbal_proc": "韓方美容施術",
        "subcat.misc_treat": "その他治療",
        ...
        "filter.doc_gp": "一般医",
        "filter.experience": "施術経歴",
        "filter.exp_05": "0-5年",
        "filter.exp_510": "5-10年",
        "filter.exp_10p": "10年以上",
        "filter.auth_benefits": "認証および特典",
        "filter.auth_registered": "外国人診療認証機関",
        "filter.auth_excellent": "外国人診療優秀機関",
        "filter.review_title": "⭐ レビューカテゴリーフィルター（星評価 0-5点）",
        "filter.option_all": "全て",
        "filter.r_satisfaction": "施術満足度",
        "filter.r_cost": "コスパ",
        "filter.r_contact_speed": "連絡の迅速さ",
        "filter.r_waiting_speed": "待ち時間・迅速さ",
        "filter.r_language": "疎通の便利さ（言語）",
        "filter.r_staff_kindness": "スタッフの親切さ",
        "filter.r_doctor_explanation": "医師の丁寧な説明",
        "filter.r_honesty": "正直な診療（過剰診療なし）",
        "filter.r_location": "アクセスの良さ",
        "filter.r_facility": "施設の快適さ",
        "filter.r_aftercare": "アフターケア満足度",
        "filter.r_parking": "駐車の便利さ",

        "compare.title": "カスタムデザイン施術 vs 工場型一括施術",
        "compare.subtitle": "安価な流れ作業のレーザー設定か、院長による手動調整のデザイン施術か、ご自身でお選びください。",
        "compare.factory_title": "工場型クリニック",
        "compare.boutique_title": "Komicare ブティック",
        "compare.factory_price": "100,000 KRW",
        "compare.boutique_price": "200,000 KRW",
        "compare.factory_price_html": "100,000 <span>KRW</span>",
        "compare.boutique_price_html": "200,000 <span>KRW</span>",
        "compare.boutique_badge": "VIP基準",
        "compare.factory_desc": "誰が担当するかわからないランダムな医師による3分間の施術、安全設定なし",
        "compare.boutique_desc": "1:1院長専任のデザイン施術、パルス幅手動調整＆サフィア冷却ケア",
        "compare.factory_consult": "カウンセラーによる強引な営業",
        "compare.boutique_consult": "専任医師による直接の肌質精密カウンセリング",
        "compare.factory_care": "帰国後のアフターケア全無",
        "compare.boutique_care": "帰国後も遠隔でアフターケアを完璧保証",
        "compare.factory_risk": "肌バリア破壊＆レーザー火傷リスク高",
        "compare.boutique_risk": "皮膚科専門医の集刀により安全性を最大化",
        "compare.btn": "安全なブティック施術を選択する",
        "compare.factory_consult_desc": "カウンセラーがインセンティブ達成のために高額なパッケージを強引に勧めます。",
        "compare.factory_risk_desc": "すべての肌タイプに一律のプリセット設定を適用するため、火傷や色素沈着のリスクが高いです。",
        "compare.factory_care_desc": "施術後はすぐ帰宅させられ、帰国後には一切の問い合わせ窓口がありません。",
        "compare.boutique_consult_desc": "医師が直接肌の厚みやバリアを分析し、1:1で施術デザインを組み立てます。",
        ...
        "hero.headline": "K-Beautyで渡韓予定？ <br>",
        "hero.headline_gradient": "サクラや「工場型」クリニックにうんざり？",
        "hero.subheadline": "1) 100%来院認証済みのリアルな口コミ<br>2) 外国人患者の直接の体験談と正直なレビュー<br>3) 広告やスポンサー提携の一切排除<br>4) 正確で透明な施術費用の案内<br>5) 優れた審美眼を持つ医師を直接指名可能<br>6) 帰国後も安心のポストケア（アフターケア）提供",
...
const specialtyTranslations = {
    en: {
        ...
        "vascular laser calibration": "Vascular Laser Calibration",
        "rosacea & redness recovery": "Rosacea & Redness Recovery",
        "ultrasonic rejuvenation": "Ultrasonic Rejuvenation",
        "1:1 wavelength tuning": "1:1 Wavelength Tuning",
        "dual-cooling safety protocols": "Dual-Cooling Safety Protocols",
        "high-fluence pigment management": "High-Fluence Pigment Management",
        "nose filler": "Nose Filler",
        "square jaw botox": "Square Jaw Botox",
        "genuine consumables logged": "Genuine Consumables Logged",
        "ultherapy & shurink custom setups": "Ultherapy & Shurink Custom Setups",
        "epidermal thickness diagnostic": "Epidermal Thickness Diagnostic",
        "ulthera": "Ulthera",
        "shurink": "Shurink",
        "nd:yag & pico laser certified": "Nd:YAG & Pico Laser Certified",
        "100% physician consultation": "100% Physician Consultation",
        "youth acne barrier healing": "Youth Acne Barrier Healing",
        "laser hair removal": "Laser Hair Removal",
        "fraxel": "Fraxel",
        "natural adhesion double eyelid": "Natural Adhesion Double Eyelid",
        "non-incisional ptosis correction": "Non-incisional Ptosis Correction",
        "under-eye fat relocation": "Under-Eye Fat Relocation",
        "매몰/자연유착 쌍꺼풀": "Natural Adhesion Double Eyelid",
        "비절개 눈매교정": "Non-incisional Ptosis Correction",
        "눈밑지방재배치": "Under-Eye Fat Relocation",
        ...
        "motiva breast augmentation": "Motiva Breast Augmentation",
        "autologous fat breast augmentation": "Autologous Fat Breast Augmentation",
        "모티바 가슴 확대": "Motiva Breast Augmentation",
        "자가지방 가슴 확대": "Autologous Fat Breast Augmentation",
        "laminate": "Laminate",
        ...
        "herbal diet medicine": "Herbal Diet Medicine",
        "acupuncture thread lifting": "Acupuncture Thread Lifting",
        "다이어트 한약": "Herbal Diet Medicine",
        "매선 침": "Acupuncture Thread",
        "scalp mesotherapy": "Scalp Mesotherapy",
        "diet herbal injection": "Diet Herbal Injection",
        ...
        "pico laser toning": "Pico Laser Toning",
        "피코 레이저": "Pico Laser",
        ...
        "pore & sebum care": "Pore & Sebum Care",
        "breast augmentation": "Breast Augmentation",
        "implants": "Implants",
        "rosacea & redness care": "Rosacea & Redness Care",
        "natural double eyelid": "Natural Double Eyelid",
    ...
    ko: {
        ...
        "laser toning": "레이저 토닝",
        "vascular laser calibration": "혈관 레이저 미세 조정",
        "rosacea & redness recovery": "홍조 및 붉은 기 회복",
        "ultrasonic rejuvenation": "초음파 리쥬베네이션",
        "1:1 wavelength tuning": "1:1 파장 튜닝",
        "dual-cooling safety protocols": "듀얼 쿨링 안전 프로토콜",
        "high-fluence pigment management": "고출력 색소 치료",
        "nose filler": "코 필러",
        "square jaw botox": "사각턱 보톡스",
        "genuine consumables logged": "정품 팁 EMR 로그 등록",
        "ultherapy & shurink custom setups": "울쎄라 & 슈링크 맞춤 설정",
        "epidermal thickness diagnostic": "표피 두께 진단 검진",
        "ulthera": "울쎄라",
        "shurink": "슈링크",
        "nd:yag & pico laser certified": "Nd:YAG & 피코 인증의",
        "100% physician consultation": "100% 원장 직접 상담",
        "youth acne barrier healing": "청소년 여드름 장벽 치유",
        "laser hair removal": "레이저 제모",
        "fraxel": "프락셀",
        "natural adhesion double eyelid": "자연유착 쌍꺼풀",
        "non-incisional ptosis correction": "비절개 눈매교정",
        "under-eye fat relocation": "눈밑지방재배치",
        "매몰/자연유착 쌍꺼풀": "매몰/자연유착 쌍꺼풀",
        "비절개 눈매교정": "비절개 눈매교정",
        "눈밑지방재배치": "눈밑지방재배치",
        "silicone rhinoplasty": "실리콘 코성형",
        "functional rhinoplasty (rhinitis/septal deviation)": "기능코 성형 (비염/비중격만곡증 개선)",
        "alar reduction": "콧볼 축소",
        "기능코 성형 (비염/비중격만곡증 개선)": "기능코 성형 (비염/비중격만곡증 개선)",
        "콧볼 축소": "콧볼 축소",
        "motiva breast augmentation": "모티바 가슴 성형",
        "autologous fat breast augmentation": "자가지방 가슴 성형",
        "모티바 가슴 확대": "모티바 가슴 확대",
        "자가지방 가슴 확대": "자가지방 가슴 확대",
        "laminate": "라미네이트",
        "clear aligners": "투명 교정",
        "teeth whitening": "치아 미백",
        "라미네이트": "라미네이트",
        "투명교정": "투명교정",
        "치아 미백": "치아 미백",
        "herbal diet medicine": "다이어트 한약",
        "acupuncture thread lifting": "매선 침 리프팅",
        "다이어트 한약": "다이어트 한약",
        "매선 침": "매선 침",
        "scalp mesotherapy": "두피 메조테라피",
        "diet herbal injection": "다이어트 한방 약침",
        "쌍꺼풀": "쌍꺼풀 수술",
        "functional rhinoplasty": "기능코 성형",
        "기능코 성형": "기능코 성형",
        "liposuction": "지방 흡입",
        "fat grafting": "지방 이식",
        "mommy makeover": "마미 메이크오버",
        "laminate veneers": "라미네이트 베니어",
        "cupping therapy": "부항 치료",
        "fue hair transplant": "비절개 모발이식 (FUE)",
        "hairline design": "헤어라인 디자인",
        "모발이식": "모발이식",
        "여드름 흉터 치료": "여드름 흉터 치료",
        "pico laser toning": "피코 레이저 토닝",
        "피코 레이저": "피코 레이저",
        "acne scar treatment": "여드름 흉터 치료",
        "눈매교정": "눈매교정",
        "가슴 성형": "가슴 성형",
        "지방흡입": "지방흡입",
        "nd:yag laser": "Nd:YAG 레이저",
        "pore & sebum care": "모공 및 피지 관리",
        "breast augmentation": "가슴 확대 성형",
        "implants": "임플란트",
        "rosacea & redness care": "홍조 및 붉은기 케어",
        "natural double eyelid": "자연스러운 쌍꺼풀",
        "실리콘 코성형": "실리콘 코성형"
    },
    ja: {
        ...
        "vascular laser calibration": "血管レーザー微細調整",
        "rosacea & redness recovery": "赤ら顔・赤み回復",
        "ultrasonic rejuvenation": "超音波リジュベネーション",
        "1:1 wavelength tuning": "1:1波長チューニング",
        "dual-cooling safety protocols": "デュアル冷却安全プロトコル",
        "high-fluence pigment management": "高出力色素治療",
        "nose filler": "鼻フィラー",
        "square jaw botox": "エラボトックス",
        "genuine consumables logged": "純正チップEMRログ記録",
        "ultherapy & shurink custom setups": "ウルセラ＆シュリンクカスタム設定",
        "epidermal thickness diagnostic": "表皮厚み診断測定",
        "ulthera": "ウルセラ",
        "shurink": "シュリンク",
        "nd:yag & pico laser certified": "Nd:YAG＆ピコレーザー認定",
        "100% physician consultation": "100%医師直接カウンセリング",
        "youth acne barrier healing": "思春期ニキビバリア治療",
        "laser hair removal": "レーザー脱毛",
        "fraxel": "フラクセル",
        "natural adhesion double eyelid": "自然癒着二重術",
        "non-incisional ptosis correction": "非切開眼瞼下垂矯正",
        "under-eye fat relocation": "目の下脂肪再配置",
        "매몰/자연유착 쌍꺼풀": "埋没・自然癒着二重術",
        "비절개 눈매교정": "非切開眼瞼下垂矯正",
        "눈밑지방재배치": "目の下脂肪再配置",
        "silicone rhinoplasty": "シリコン鼻整形",
        "functional rhinoplasty (rhinitis/septal deviation)": "機能鼻整形（鼻炎・鼻中隔湾曲症改善）",
        "alar reduction": "小鼻縮小",
        "기능코 성형 (비염/비중격만곡증 개선)": "機能鼻整形（鼻炎・鼻中隔湾曲症改善）",
        "콧볼 축소": "小鼻縮小",
        "motiva breast augmentation": "モティバ豊胸術",
        "autologous fat breast augmentation": "自己脂肪注入豊胸術",
        "모티바 가슴 확대": "モティバ豊胸術",
        "자가지방 가슴 확대": "自己脂肪注入豊胸術",
        "laminate": "ラミネートベニア",
        "clear aligners": "マウスピース矯正",
        "teeth whitening": "オフィスホワイトニング",
        "라미네이트": "ラミネートベニア",
        "투명교정": "マウスピース矯正",
        "치아 미백": "オフィスホワイトニング",
        "herbal diet medicine": "韓方ダイエット薬",
        "acupuncture thread lifting": "埋線（美容鍼）リフト",
        "다이어트 한약": "韓方ダイエット薬",
        "매선 침": "埋線（美容鍼）",
        "scalp mesotherapy": "頭皮メソセラピー",
        "diet herbal injection": "韓方ダイエット輪郭注射",
        "쌍꺼풀": "二重整形",
        "functional rhinoplasty": "機能鼻整形",
        "기능코 성형": "機能鼻整形",
        "liposuction": "脂肪吸引",
        "fat grafting": "脂肪移植",
        "mommy makeover": "マミメイクオーバー",
        "laminate veneers": "ラミネートベニア",
        "cupping therapy": "カッピング治療",
        "fue hair transplant": "FUE自毛植毛",
        "hairline design": "ヘアラインデザイン",
        "모발이식": "自毛植毛",
        "여드름 흉터 치료": "ニキビ跡治療",
        "pico laser toning": "ピコレーザートーニング",
        "피코 레이저": "ピコレーザー",
        "acne scar treatment": "ニキビ跡治療",
        "눈매교정": "眼瞼下垂矯正（目元矯正）",
        "가슴 성형": "豊胸・胸部整形",
        "지방흡입": "脂肪吸引",
        "nd:yag laser": "Nd:YAGレーザー",
        "pore & sebum care": "毛穴・皮脂ケア",
